...
/**
 * This is the model class for table "maaltijdtype".
 *
 * The followings are the available columns in table 'maaltijdtype':
 * @property integer $id
 * @property string $omschrijving
 */
class Maaltijdtype extends CCustomActiveRecord
{
	/**
