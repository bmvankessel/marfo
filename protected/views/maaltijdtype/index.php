...
*/
	...
	'dataProvider'=>$dataProvider,
        ...
        'summaryText'=>'<h1>Maaltijdtypen <span style="font-size:12px">{start} t/m {end} van {count}<span></h1>',
    ...
    echo CHtml::tag('button', array( 'type'=>'button','role'=>'maaltijdtype-add','class'=>'btn btn-success'), 'Nieuw Type');

    $this->renderPartial('_create');

    Yii::app()->clientScript->registerScriptFile($this->createUrl('js/maaltijdtype.js'));
?>
